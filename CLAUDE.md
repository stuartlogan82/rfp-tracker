...
- **Rfp:** id, name, agency, status (Active/Won/Lost/NoBid/Archived), timestamps
- **Deadline:** id, rfpId, date, time, label, context, completed, timestamps
- **Document:** id, rfpId, filename, filepath, mimeType, uploadedAt
...
- **Always mock:** OpenAI API calls, filesystem I/O in unit tests, Prisma client (use a mock or in-memory DB).
